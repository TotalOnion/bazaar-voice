...
class Pr_Bazaarvoice_Admin {
	...
	public function enqueue_scripts() {
		...
		*/
		wp_enqueue_script(
			...
			plugin_dir_url(__FILE__) . 'js/pr-bazaarvoice-block.js',
	...
	*/
	public function register_block()
	{
		...
		// Register the block
		$plugin_public = new Pr_Bazaarvoice_Public( $this->plugin_name, $this->version );
		register_block_type(
			$this->plugin_name.'/bazaarvoice',
			array(
				'editor_script' => $this->plugin_name.'-block',
				'render_callback' => array( $plugin_public, 'render_block' )
			)
		);
	}
	...
	*/
	...
	public function render_section_intro() {
		_e(
			'Add the BazaarVoice code snippets below',
			'PR Bazaarvoice'
		);
	}

	/**
	 * Render inputs on the settings page
	 */
	public function render_fields($array) {
		...
		include __DIR__ . '/partials/pr-bazaarvoice-default-url.php';
	}
